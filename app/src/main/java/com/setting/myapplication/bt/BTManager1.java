...
public class BTManager1 implements BTListener, ReceiveListener {
    private final String TAG = "BTManager1";
...
/*    public String UUID_NOTIFY = "0000FE62-0000-1000-8000-00805F9B34FB";
    ...
    private static volatile BTManager1 singletonInstance = null;

    public static BTManager1 getInstance(Context context) {
        if (singletonInstance == null) {
            synchronized (BTManager1.class) {
                if (singletonInstance == null) {
                    singletonInstance = new BTManager1(context);
                }
            }
        }
    ...
    public static BTManager1 getInstance() {
        return singletonInstance;
    }
    ...
    public BTManager1(Context context) {
        init(context);
    }
    ...
    public void init(Context context) {
        ...
        Intent gattServiceIntent = new Intent(this.context, BluetoothLeService1.class);
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            bluetoothLeService1 = ((BluetoothLeService1.LocalBinder) service).getService();

            if (!bluetoothLeService1.initialize(context, BTManager1.this)) {
    ...
    public boolean connect(String addr) {
        ...
        boolean result = bluetoothLeService1.connect(deviceAddress);
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
                ...
                if (uuid.toUpperCase().equals(UUID_NOTIFY.toUpperCase())) {
                    ...
                    bluetoothLeService1.setCharacteristicNotification(mNotifyCharacteristic, true);
    ...
    public boolean sendData(byte[] buf) {
        ...
        if (mWriteCharacteristic != null) {
            if (bluetoothLeService1 != null)
                if (bluetoothLeService1.mBluetoothGatt != null) {
                    ...
                    for (int i = 0; i - 1 < buf.length / nMtu; i++) {
                        ...
                        rtn = bluetoothLeService1.mBluetoothGatt.writeCharacteristic(mWriteCharacteristic);
    ...
    public void onBTState(EnumBTState state) {
        ...
        switch (enumBTState) {
            ...
            case services_discovered: {
                ...
                if (bluetoothLeService1 != null) {
                    if (setGattServices(bluetoothLeService1.getSupportedGattServices())) {
