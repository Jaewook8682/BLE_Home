...
public class BTManager4 implements BTListener, ReceiveListener {
    private final String TAG = "BTManager4";
...
/*    public String UUID_NOTIFY = "0000FE62-0000-1000-8000-00805F9B34FB";
    ...
    private static volatile BTManager4 singletonInstance = null;

    public static BTManager4 getInstance(Context context) {
        if (singletonInstance == null) {
            synchronized (BTManager4.class) {
                if (singletonInstance == null) {
                    singletonInstance = new BTManager4(context);
                }
            }
        }
    ...
    public static BTManager4 getInstance() {
        return singletonInstance;
    }
    ...
    private BluetoothLeService4 bluetoothLeService4;
    ...
    public BTManager4(Context context) {
        init(context);
    }
    ...
    public void init(Context context) {
        ...
        Intent gattServiceIntent = new Intent(this.context, BluetoothLeService4.class);
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            bluetoothLeService4 = ((BluetoothLeService4.LocalBinder) service).getService();

            if (!bluetoothLeService4.initialize(context, BTManager4.this)) {
    ...
    public boolean connect(String addr) {
        ...
        boolean result = bluetoothLeService4.connect(deviceAddress);
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
                ...
                if (uuid.toUpperCase().equals(UUID_NOTIFY.toUpperCase())) {
                    ...
                    bluetoothLeService4.setCharacteristicNotification(mNotifyCharacteristic, true);
    ...
    public boolean sendData(byte[] buf) {
        ...
        if (mWriteCharacteristic != null) {
            if (bluetoothLeService4 != null)
                if (bluetoothLeService4.mBluetoothGatt != null) {
                    ...
                    for (int i = 0; i - 1 < buf.length / nMtu; i++) {
                        ...
                        rtn = bluetoothLeService4.mBluetoothGatt.writeCharacteristic(mWriteCharacteristic);
   ...
   /*
    ...
    public void onBTState(EnumBTState state) {
        ...
        switch (enumBTState) {
            ...
            case services_discovered: {
                ...
                if (bluetoothLeService4 != null) {
                    if (setGattServices(bluetoothLeService4.getSupportedGattServices())) {
    ...
    public void onChanged(byte[] data) {
        Util_Byte.LogToHexString("onChange4", data, data.length);
