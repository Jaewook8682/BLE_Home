...
public class BTManager3 implements BTListener, ReceiveListener {
    private final String TAG = "BTManager3";
    ...
    //-
    ///public String UUID_NOTIFY = "741c12b9-e13c-4992-8a5e-fce46dec0bff";
...
/*    public String UUID_NOTIFY = "0000FE62-0000-1000-8000-00805F9B34FB";
    ...
    private static volatile BTManager3 singletonInstance = null;

    public static BTManager3 getInstance(Context context) {
        if (singletonInstance == null) {
            synchronized (BTManager3.class) {
                if (singletonInstance == null) {
                    singletonInstance = new BTManager3(context);
                }
            }
        }
    ...
    public static BTManager3 getInstance() {
        return singletonInstance;
    }
    ...
    private BluetoothLeService3 bluetoothLeService3;
    ...
    public BTManager3(Context context) {
        init(context);
    }
    ...
    public void init(Context context) {
        ...
        Intent gattServiceIntent = new Intent(this.context, BluetoothLeService3.class);
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            bluetoothLeService3 = ((BluetoothLeService3.LocalBinder) service).getService();

            if (!bluetoothLeService3.initialize(context, BTManager3.this)) {
    ...
    public boolean connect(String addr) {
        ...
        boolean result = bluetoothLeService3.connect(deviceAddress);
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
                ...
                if (uuid.toUpperCase().equals(UUID_NOTIFY.toUpperCase())) {
                    ...
                    bluetoothLeService3.setCharacteristicNotification(mNotifyCharacteristic, true);
    ...
    public boolean sendData(byte[] buf) {
        ...
        if (mWriteCharacteristic != null) {
            if (bluetoothLeService3 != null)
                if (bluetoothLeService3.mBluetoothGatt != null) {
                    ...
                    for (int i = 0; i - 1 < buf.length / nMtu; i++) {
                        ...
                        rtn = bluetoothLeService3.mBluetoothGatt.writeCharacteristic(mWriteCharacteristic);
    ...
    public void onBTState(EnumBTState state) {
        ...
        switch (enumBTState) {
            ...
            case services_discovered: {
                ...
                if (bluetoothLeService3 != null) {
                    if (setGattServices(bluetoothLeService3.getSupportedGattServices())) {
